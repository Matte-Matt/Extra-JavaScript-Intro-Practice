...
function dollarToEuro(dollar) {
  console.log(`${dollar * 0.85} EUR`);
}
dollarToEuro(8675309);
...
function euroTripMoney(dollar, country) {
  if (country === "Great Britain" && dollar >= 0) {
    console.log(
      `Your exchange rate for ${dollar} Dollar(s) in ${country} will be ${
        dollar * 0.77
      } British Pounds.`
    );
  } else if (country === "Turkey" && dollar >= 0) {
    console.log(
      `Your exchange rate for ${dollar} Dollar(s) in ${country} will be ${
        dollar * 6.96
      } Turkish Lira.`
    );
  } else if (country === "Bulgaria" && dollar >= 0) {
    console.log(
      `Your exchange rate for ${dollar} Dollar(s) in ${country} will be ${
        dollar * 1.66
      } Bulgarian Lev.`
    );
  } else if (country === "Ukraine" && dollar >= 0) {
    console.log(
      `Your exchange rate for ${dollar} Dollar(s) in ${country} will be ${
        dollar * 27.7
      } Ukrainian Hryvnia.`
    );
  } else if (country === "Germany" && dollar >= 0) {
    console.log(
      `Your exchange rate for ${dollar} Dollar(s) in ${country} will be ${
        dollar * 0.85
      } EUR.`
